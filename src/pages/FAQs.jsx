  ...
  return (
    <section className='py-12 md:py-20 bg-gray-50'>
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
        <h1 className='text-2xl sm:text-4xl md:text-5xl font-extrabold text-center text-gray-900 mb-12'>
          Frequently Asked Questions
        </h1>
        <div>
          <h2 className='text-xl sm:text-2xl font-extrabold pb-4 underline text-center'>অর্ডার ও ডেলিভারিঃ</h2>
          <div className='px-4 py-6 shadow-md mb-8 hover:shadow-xl group'>
