...
const ForgotPassword = () => {
  ...
  return (
    <section className="py-8">
      <Container>
        <div className="max-w-2xl mx-auto py-8 px-6 bg-white rounded-xl shadow border border-gray-200">
          <div>
          ...
          <div className="text-sm text-gray-500 max-w-md mt-2">
            <p>
              For security, your access token expires in 5 minutes. Use the
