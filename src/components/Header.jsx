    ...
    <header className="bg-gray-100 py-2 relative hidden md:block">
      <Container>
        <div className="flex items-center justify-between">
          ...
          <div ref={menuRef}>
            <ul
              className={`md:flex items-center gap-x-4 lg:gap-x-6 md:static transition-all ease-in-out duration-700 ${
                openMenu == true
                  ? "absolute top-0 left-0 bg-white shadow border-b-2 border-[#0000002d] py-4 w-full z-[9999] pl-4"
            ...
            >
              ...
              <li className="pb-2 md:pb-0">
                <NavLink
                  to={"/"}
                  className={({ isActive }) =>
                    `text-[14px] font-jose font-semibold hover:text-violet-600 ${
                      isActive ? "text-red-500" : "text-violet-950"
                    }`
                  }
                >
                  Home
          ...
          <div className="flex items-center gap-x-3 lg:gap-x-6">
            <div>
              <NavLink
                to={"/wishlist"}
                className={({ isActive }) =>
                  `text-[14px] font-jose font-semibold hover:text-violet-600 flex items-center gap-x-2 group border-l border-l-[#00000045] ${
                    isActive ? "text-red-500" : "text-violet-950"
                  }`
                }
              >
          ...
          >
            {openMenu == true ? (
              <GrClose className="text-2xl cursor-pointer opacity-0" />
            ) : (
